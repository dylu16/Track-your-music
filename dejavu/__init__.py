...
class Dejavu:
    ...
    def fingerprint_file(self, file_path: str, song_name: str = None) -> str:
        ...
        if song_hash in self.songhashes_set:
            return f"Song " + song_name + " is already fingerprinted"
        else:
            song_name, hashes, file_hash = Dejavu._fingerprint_worker_single_song(
                file_path,
                self.limit
            )
            song_name = song_name.replace("_", " ")
            ...
            return f"Song " + song_name + " was added successfully"
    ...
    @staticmethod
    def _fingerprint_worker_single_song(file_name, limit):
